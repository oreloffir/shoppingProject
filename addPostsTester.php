...
$imagePathArray = array("image_1498159789.jpg","image_1498424789.jpg","image_1498424889.jpg","image_1498424969.jpg","image_1498427069.jpg","image_1498427839.jpg");
$usersIdArray = array("3","5","6","7","8");
for ($i = 1; $i <=100; $i++) {
    $postId = $i;
    $userId 	    = $usersIdArray[rand(0,4)];
    $imagePath      = $imagePathArray[rand(0,5)];
    $title 			= "Post ID ".$i;
    ...
    $post = new Post(0,$title,$description,$postURL,$userId,$imagePath,time()+rand(1000,1000000),$category,$couponCode);
    if(empty($couponCode)){
